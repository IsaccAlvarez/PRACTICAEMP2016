<div class="form-group">
 ...
 <input type="text" name='name' id="nam" class="form-control" placeholder="" aria-describedby="basic-addon1">
</div>
<div class="form-group">
<label for="email">Correo</label>
<input type="text"  name="email" id="emai" class="form-control" placeholder="" aria-describedby="basic-addon1">
</div>
<div class="form-group">
<label for="tipoUser">Tipo de Usuario</label>
 <select class=" form-control" id="tUse" name="tipoUser" aria-describedby="basic-addon1">
