  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{{$user->email}}</td>
       <td>{{$user->tipoUser}}</td>
      <td>
        <button id="edit" class='btn btn-primary btn-circle glyphicon glyphicon-pencil' onClick="Mostrar({{$user->id}});" data-toggle='modal' data-target='#myModalEditUser'></button>
